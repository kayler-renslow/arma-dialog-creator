package com.armadialogcreator.installer;
...
import static com.armadialogcreator.installer.ADCInstaller.bundle;
...
class InstallerConfigWindow {
	...
	public InstallerConfigWindow(@NotNull Stage stage, @NotNull File initInstallDir) {
		...
		stage.getIcons().addAll(new Image("/com/armadialogcreator/pwindow/app.png"));
	...
	private void initPane(Stage stage) {
		...
		//header stuff
		{
			...
			//add adc icon
			ImageView imageViewAdc = new ImageView(new Image("/com/armadialogcreator/installer/adc64.png"));
			...
			//title and sub title stuff
			{
				...
				ImageView imageViewHeart = new ImageView("/com/armadialogcreator/installer/heart.png");
