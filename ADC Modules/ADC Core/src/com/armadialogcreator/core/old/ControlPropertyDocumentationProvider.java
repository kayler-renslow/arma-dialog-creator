...
public class ControlPropertyDocumentationProvider {
	...
	/**
	 ...
	 The documentation will come from {@link #CONTROL_PROPERTY_DOCUMENTATION_PATH} using {@link ControlProperty#getUserData()}<p>
	 <p>
	...
	public String getDocumentation(@NotNull ControlProperty property) {
		String path = CONTROL_PROPERTY_DOCUMENTATION_PATH.get(property.getUserData());
