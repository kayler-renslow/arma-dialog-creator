...
public enum ControlPropertyEventLookup {
	EventOnLoad(ControlPropertyLookup.EVENT_ON_LOAD, 1, "Display, Control"),
	...
	EventOnMouseZChanged(ControlPropertyLookup.EVENT_ON_MOUSE_ZCHANGED, 2, "Display, Control"),
	...
	EventOnButtonClick(ControlPropertyLookup.EVENT_ON_BUTTON_CLICK, 1, "Button"),
	...
	EventOnLbSelChanged(ControlPropertyLookup.EVENT_ON_LB_SEL_CHANGED, 2, "ListBox, ComboBox"),
	...
	EventOnLbDrop(ControlPropertyLookup.EVENT_ON_LB_DROP, 2, "Listbox, Combobox, Textbox, ActiveText, Button"),
	EventOnTreeSelChanged(ControlPropertyLookup.EVENT_ON_TREE_SEL_CHANGED, 2, "Tree"),
	...
	EventOnToolBoxSelChanged(ControlPropertyLookup.EVENT_ON_TOOL_BOX_SEL_CHANGED, 2, "Toolbox"),
	EventOnChecked(ControlPropertyLookup.EVENT_ON_CHECKED, -1, "Checkbox"),
	...
	EventOnHtmlLink(ControlPropertyLookup.EVENT_ON_HTML_LINK, 2, "HTML"),
	EventOnSliderPosChanged(ControlPropertyLookup.EVENT_ON_SLIDER_POS_CHANGED, 2, "Slider"),
	EventOnObjectMoved(ControlPropertyLookup.EVENT_ON_OBJECT_MOVED, 2, "Object"),
	EventOnMenuSelected(ControlPropertyLookup.EVENT_ON_MENU_SELECTED, 2, "Context menu"),
	EventOnDraw(ControlPropertyLookup.EVENT_ON_DRAW, -1, "Map"),
	EventOnVideoStopped(ControlPropertyLookup.EVENT_ON_VIDEO_STOPPED, 2, "Control");
