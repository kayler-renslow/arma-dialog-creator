...
public class HeaderToProject {
	...
	private ArmaControl getArmaControl(@NotNull String ownerDialogName, @NotNull Project project, @NotNull HeaderClass headerClass) throws HeaderConversionException {
		...
		ControlClassOld extendClass = getExtendControlClass(project, ownerDialogName, headerClass);
	...
	@Nullable
	private ControlClassOld getExtendControlClass(@NotNull Project project, @NotNull String ownerDialogName, @NotNull HeaderClass headerClass) throws HeaderConversionException {
		ControlClassOld extendClass = null;
	...
	private void loadAllNestedClasses(@NotNull Project project, @NotNull HeaderClass headerClass,
									  @NotNull ControlClassOld controlClass) {
		for (ControlClassOld cc : controlClass.getAllNestedClasses()) {
	...
	/**
	 ...
	 come from {@link ControlClassOld#getAllChildProperties()}.
	 <p>
	 This method will also load any nested {@link ControlClassOld} inside <code>controlClass</code> by recursively
	 calling this method.

	 @param project project to use
	 @param headerClass the {@link HeaderClass} to fetch {@link HeaderAssignment} from
	 @param controlClass the {@link ControlClassOld} to pair {@link HeaderAssignment}s with {@link ControlProperty}.
	...
	@NotNull
	private ControlClassOld createAndAppendCustomControlClass(@NotNull Project project, @NotNull String dialogClassName, @NotNull HeaderClass headerClass) throws HeaderConversionException {
		...
		if (headerClass.getExtendClassName() != null) {
			ControlClassOld cc = getExtendControlClass(project, dialogClassName, headerClass);
