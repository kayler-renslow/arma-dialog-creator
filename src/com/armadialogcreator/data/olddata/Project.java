...
public class Project extends com.armadialogcreator.application.Project /*TODO extends is temporary*/ implements SpecificationRegistry {
	...
	/**
	 Will get the {@link ControlClassOld} instance by name. First will search {@link #getProjectCustomControlClassRegistry()}.
	...
	public ControlClassOld findControlClassByName(@NotNull String className) {
		ControlClassOld controlClass = projectCustomControlClassRegistry.findControlClassByName(className);
