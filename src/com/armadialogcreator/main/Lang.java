...
import static com.armadialogcreator.main.Lang.Application.APPLICATION_NAME;
...
public interface Lang {
	...
	static ResourceBundle getBundle(@NotNull String bundleName) throws MissingResourceException {
		return ResourceBundle.getBundle("com.armadialogcreator." + bundleName, ArmaDialogCreator.getCurrentLocale());
	}
